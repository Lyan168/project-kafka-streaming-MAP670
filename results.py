...
directory = os.path.dirname(f'./Results/')
...
# df= pd.concat([batch_result_df,knn_result_df, pa_results_df, logistic_result_df, ht_result_df, hat_result_df, arf_results_df,snarimax_results_df])
...
fig.suptitle("RMSE" )
plt.tight_layout()
plt.savefig(f'./Results/RMSE.png')
...
fig.suptitle("SMAPE")
plt.tight_layout()
plt.savefig(f'./Results/SMAPE.png')
